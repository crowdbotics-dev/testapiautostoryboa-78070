...
## Project Structure
    ...
    ├── testapiautostoryboa_78070  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_78070`
...
2. Clone this repo and `cd testapiautostoryboa_78070`
